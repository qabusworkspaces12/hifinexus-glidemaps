  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case TransactionDetailsRow:
            return TransactionDetailsRow(data);
          case RatingsRow:
            return RatingsRow(data);
          case TermsOfServicesRow:
            return TermsOfServicesRow(data);
          case CreateProductRow:
            return CreateProductRow(data);
          case CreateCategoryRow:
            return CreateCategoryRow(data);
          case PaymentMethodsRow:
            return PaymentMethodsRow(data);
          case ActivitiesRow:
            return ActivitiesRow(data);
          case PurchaseTypesRow:
            return PurchaseTypesRow(data);
          case UsersRow:
            return UsersRow(data);
          case CategoriesRow:
            return CategoriesRow(data);
          case SupportCenterRow:
            return SupportCenterRow(data);
          case OrdersRow:
            return OrdersRow(data);
          case VapeProductsRow:
            return VapeProductsRow(data);
          default:
            return null;
        }
